...
async function seedDatabase() {
    try {
        ...
        await User_1.default.updateOne({ _id: users[0]._id }, { team: teams[0]._id });
        await User_1.default.updateOne({ _id: users[1]._id }, { team: teams[0]._id });
        await User_1.default.updateOne({ _id: users[2]._id }, { team: teams[1]._id });
        await User_1.default.updateOne({ _id: users[3]._id }, { team: teams[2]._id });
        await User_1.default.updateOne({ _id: users[4]._id }, { team: teams[2]._id });
        // Create activities
